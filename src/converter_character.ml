(** Converter_character module provides basement function to convert a character to other character.
    This module will be able to use conversion between romaji and other character, but
    should use Converter_romaji to get valid result.
*)
